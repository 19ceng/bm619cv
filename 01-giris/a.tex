...
\frame {
	...
	\begin{itemize}
		\item piksellerle "anlamı" arasında köprü kurmaktır
	\end{itemize}
...
\frame {
	...
	\begin{itemize}
		\item Metrik 3d bilgi: derinlik, yükseklik, alan vs
		\item Anlamsal bilgi: ağaç, ev, hareketli, insan vs
	\end{itemize}
}
...
\frame {
	...
	\includegraphics[width=0.9\textwidth]{img/08-why.png}
}
...
\frame {
	...
	\includegraphics[height=0.9\textheight]{img/34-synt.png}
}
